...
//    private static float ambienteL1[] = {1f,1f,1f,1.0f };
//    private static float diffusaL1[] = {1f,1f,1f,1.0f };
//    private static float especularL1[] = {1f,1f,1f,1.0f };
...
//
        ...
        gl.glLightf(GL.GL_LIGHT2, GL.GL_CONSTANT_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT2, GL.GL_LINEAR_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT2, GL.GL_QUADRATIC_ATTENUATION,0.5f);
        ...
        gl.glLightf(GL.GL_LIGHT3, GL.GL_CONSTANT_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT3, GL.GL_LINEAR_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT3, GL.GL_QUADRATIC_ATTENUATION,0.5f);
        ...
        gl.glLightf(GL.GL_LIGHT4, GL.GL_CONSTANT_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT4, GL.GL_LINEAR_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT4, GL.GL_QUADRATIC_ATTENUATION,0.5f);
        ...
        gl.glLightf(GL.GL_LIGHT5, GL.GL_CONSTANT_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT5, GL.GL_LINEAR_ATTENUATION,0.5f);
        gl.glLightf(GL.GL_LIGHT5, GL.GL_QUADRATIC_ATTENUATION,0.5f);
        ...
        gl.glLightf(GL.GL_LIGHT6, GL.GL_QUADRATIC_ATTENUATION,0.5f);
